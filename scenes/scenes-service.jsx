  ...
  return (
    <Sprite start={start} end={end}>
      {({ localTime }) => {
        ...
        const actes = [
          { label: 'Consultation généraliste', sub: 'accès & rapidité garantis', price: 'Au-dessus du tarif Sécu', color: C.gold },
          { label: 'Consultation spécialiste', sub: 'cardio · ophtalmo · gynéco…', price: 'Au-dessus du tarif Sécu', color: C.gold },
          ...
          <div style={{ position: 'absolute', inset: 0, background: C.bg0 }}>
            ...
            <div style={{ position: 'absolute', right: 96, top: 392, width: 760 }}>
              ...
              <div style={{ marginTop: 16, fontSize: 13, color: C.whiteDim, lineHeight: 1.5 }}>
                Le dépassement sur les consultations finance l'<span style={{ color: C.gold }}>accès garanti et la rapidité</span>. Biologie et imagerie restent au <span style={{ color: C.green }}>tarif Sécu, remboursées</span>.
              </div>
            </div>
